...
function Sidebar(){
    ...
    return(
        <div className = 'w-[350px] h-full fixed z-10 overflow-x-hidden top-0 border-orange-600 border-0 px-[25px] py-[35px] bg-white flex-shrink-0'>
            ...
            <div className = 'absolute bottom-8 flex items-center gap-5 text-[#525252] text-lg font-medium cursor-pointer'>
