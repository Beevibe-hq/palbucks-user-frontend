...
const Landingcampaign = (props) => {
  return (
    <div className='shrink-0 max-w-[574px]' >
        ...
        className = ' mb-[25px] shrink-0 w-[574px] h-[376px] rounded-3xl ' />

        <div className="pr-[30px]">
            <h3 className='mb-[15px] text-[34px] font-bold tracking-[0.128px] leading-[42px] ' >
                The Fight for our Environment in Lagos Begins Today
            </h3>

            <p className=' mb-[20px] line-clamp-2 text-[#011217] text-[20px] font-arial leading-[35px] tracking-[-0.021px;] ' >
            ...
            className='landingpageprogressbar w-full h-[18px] appearance-none rounded-full  mb-1 phones:mb-4 xphones:mb-5 md:mb-[14px]' />        
