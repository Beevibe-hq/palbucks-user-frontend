...
function Navbar(){
    ...
    return(
        <div className = 'py-[10px] px-4 md:px-10 h-[90px] md:h-[100px] fixed top-0 right-0 left-0 md:left-[250px] lg:left-[280px] xl:left-[320px] z-20 bg-[#F9F9F9] shadow-[0px_0px_16px_rgba(0,0,0,0.04)] flex items-center justify-between' >
            ...
            <div className = 'flex items-center gap-[15px] md:gap-8'>
                ...
                <img src={userimg} alt="user avatar" className='w-[35px] md:w-[40px]' />
                <img src={applogo} alt="Palbucks logo" className = "block w-[22px] md:hidden" />
