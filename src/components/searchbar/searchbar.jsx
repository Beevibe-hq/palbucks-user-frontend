...
function Searchbar(props){
    ...
    return(
        <input type="search" className={` ${props.onDonorPage ? 'w-[100%] xphones:w-[80%] md:w-[320px] brkpoint:w-[300px] lg:w-[400px] xl:w-[600px] ' : 'w-[100%] xphones:w-[80%] md:w-[320px] brkpoint:w-[300px] lg:w-[345px] xl:w-[480px]'}  h-[30px] phones:h-[40px] xl:h-[44px] 
