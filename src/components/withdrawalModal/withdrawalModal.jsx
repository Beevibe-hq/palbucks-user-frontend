...
const WithdrawalModal = ({ withdrawalModal, setWithdrawalModal }) => {
    
    const navigate = useNavigate()
        

    return (
        <div className={`w-full fixed z-50 inset-0 overflow-y-auto ${withdrawalModal ? 'block' : 'hidden'}`}>
                    ...
                    shadow-[0px_0px_72px_0px_rgba(0,0,0,0.04)] font-arial mx-auto`} >                        
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="w-full flex flex-col items-center px-2 md:px-4 xl:px-6 " >
                                <h2 className="mb-[22px] md:mb-[62px] text-[16px] md:text-[35px] font-black text-center " >Select method of withdrawal</h2>
                                <div className="mb-[22px] md:mb-[56px] w-full flex justify-between items-center " >
                                    <div className="flex gap-2 items-center " >
                                        ...
                                        <h3 className="text-[12px] md:text-[22px] font-bold text-[#011217] " >Withdraw into bank account</h3>
                                    </div>
                                ...
                                <p className="text-center text-[11px] md:text-[18px]  " >
                                    Bank account withdrawal option is available to only Nigerian users at this time. We're working on expanding this feature. Thank you for your understanding.
                                </p>
                            </div>
