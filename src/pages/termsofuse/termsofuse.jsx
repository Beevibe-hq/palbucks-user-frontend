        ...
        <div className='bg-[#F9F9F9] min-h-full overflow-y-auto max-h-[100vh]'>
            ...
            <div className =  {` ${sidebarslid ? 'ml-[100px]' :' brkpoint:ml-[250px] lg:ml-[280px] xl:ml-[320px]' } ${isMobile && sidebaropen ? 'blur-sm' : '' } `} >
                ...
                <div className = 'fold:px-2 phones:px-3 md:px-3 lg:pl-[25px] lg:pr-[27px] pt-8 md:pt-12 pb-5 mt-[90px] md:mt-[100px] font-merriweather w-full h-full '>
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >1. The Services Description:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px] " >
                        The Services are offered as a platform to allow an individual, entity or non-profit organization 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >2. Payment Processor:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px] " >
                        ...
                        See our <span className=" text-[#37BCF7] " >Privacy Policy</span>.
                    </p>

                    <h4 className="text-[22px] font-black mb-3 " >3. Transaction Fee:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px] " >
                        ...
                        <span className="text-[#37BCF7]" > Pricing </span>.
                    </p>

                    <h4 className="text-[22px] font-black mb-3 " >4. The Services are Platforms; We are not a Broker, Financial Institution, Creditor or Charity:</h4>
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >5. No Solicitation:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        The Platform is offered to help Organizers raise money. Palbucks merely provides the technology to allow 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >6. Donors:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >7. Organizers:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        You, as an Organizer, represent, warrant, and covenant that: (i) all information you provide in connection 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >8. Your Registration Obligations:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        You may be required to register with Palbucks to access and use certain features of the Services. If you choose 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >9. Taxes:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        It is your responsibility to determine what, if any, taxes apply to the Donations you receive through your use 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >10. Member Account, Password and Security:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >11. Content Manifestly Made Public by the User:</h4>
                    <p className="text-[18px] leading-6 mb-5 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >12. Third-Party Communications:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        If you use any feature of the Services that allows you to communicate with third parties (such as to refer 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >13. Sales Prohibited on the Platform:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        You are not permitted to offer any goods or service in exchange for a Donation on the Platform.
                    </p>

                    <h4 className="text-[22px] font-black mb-3 " >14. Data Retention:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        You acknowledge that Palbucks has no obligation to you to retain data relating to any account or 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >15. Mobile Services and Text Messages:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        The Palbucks Services include certain features that may be made available via a mobile device, including the ability to: 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >16. Prohibited Contents</h4>
                    <p className="text-[18px] leading-6 mb-5 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >1. Services Content, Software and Trademarks:</h4>
                    <p className="text-[18px] leading-6 mb-5 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >2. Third-Party Material:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                        Under no circumstances will Palbucks be liable in any way for any content or materials of any third parties 
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >3. User Content Transmitted Through the Services:</h4>
                    <p className="text-[18px] leading-6 mb-8 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >4. Copyright or Trademark Complaints:</h4>
                    <p className="text-[18px] leading-6 mb-20 tracking-[0.8px]" >
                    ...
                    <h4 className="text-[22px] font-black mb-3 " >1. Arbitration; Class Action Waiver:</h4>
                    <p className="text-[18px] leading-6 mb-5 tracking-[0.8px]" >
