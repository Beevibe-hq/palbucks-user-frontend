...
import tetherIcon from "../../images/wallet/tether2.svg"


function FundWalletWithCrypto() {
            ...
            { pageDisplay == 'bankFunding' ? 
                <div className="">
                    <h1 className="text-center text-[16px] md:text-[32px] font-black mb-4 text-[#000000] " >
                        Fund your wallet with USDT crypto
                    </h1>
                    <p className="mb-[56px] md:mb-[104px] text-[14px] md:text-[20px] text-[#000000] text-center " >
                        Easily add funds to your wallet using USDT (Tether) cryptocurrency.
                    </p>
                    <div className="mb-[117px] md:mb-[242px] flex flex-col gap-3 md:gap-5 mx-auto max-w-[800px] " >
                        ...
                        <div className="relative h-fit" >
                            ...
                            />
                            <img src={tetherIcon} alt="" className="absolute right-3 md:right-5 transform cursor-pointer top-1/2 -translate-y-1/2 w-8 " />
                        </div>
                    </div>
...
export default FundWalletWithCrypto