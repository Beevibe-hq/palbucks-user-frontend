...
function Notificationsicon(props){
    ...
    return(
        ...
        >
            ...
            <svg onClick={props.onClick} width="22" height="30" viewBox="0 0 22 30" fill=  {props.active ? "#37BCF7" : "none"} xmlns="http://www.w3.org/2000/svg" id="notificationsicon" className = ' cursor-pointer hidden md:block w-[21px]' alt="notifications icon">
