...
function Likeicon(props){
    ...
    return(
        <svg className="inline-block" width="20" height="20" viewBox="0 0 20 18" fill={props.liked ? '#35FAA0' : 'none'}   xmlns="http://www.w3.org/2000/svg">
            ...
            stroke={props.color === 'black' ? 'black' : "#8E8E93"} strokeWidth={"2" } strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
